            ...
            <div class="container">
                <div class="inner-container text-center mb-6">
                    <h1 class="mb-0 lh-base position-relative">
                        ...
                        Registration successfully made.
                    </h1>
                    <p>
                        A verification link has been sent to your email account. Please check your <b>spam folder</b> if not found in your <b>inbox</b> to verify your GMSA CKTUTAS membership.
                        <br><br>
                        <a href="<?= PROOT; ?>">Go home.</a>
                    </p>
                </div>
            </div>
        </section>
