    <footer class="bg-dark position-relative overflow-hidden pt-6" data-bs-theme="dark">
        ...
        <div class="position-absolute top-0 end-0 mt-n3 me-n4">
            <img src="<?= PROOT; ?>assets/media/decoration-pattern-2.svg" style="opacity:0.05;" alt="">
        </div>

        <div class="container position-relative mt-5">
            <div class="row g-4 justify-content-between">
                <div class="col-lg-3">
                    <a class="me-0" href="<?= PROOT; ?>">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <ul class="list-inline mb-0 mt-3">
                                <li class="list-inline-item"> <a target="_blank" class="btn btn-xs btn-icon btn-light-soft" href="<?= $site_row["facebook"]; ?>"><i class="bi bi-facebook lh-base"></i></a> </li>
                                <li class="list-inline-item"> <a target="_blank" class="btn btn-xs btn-icon btn-light-soft" href="<?= $site_row["instagram"]; ?>"><i class="bi bi-instagram lh-base"></i></a> </li>
                                <li class="list-inline-item"> <a target="_blank" class="btn btn-xs btn-icon btn-light-soft" href="<?= $site_row["twitter"]; ?>"><i class="bi bi-twitter lh-base"></i></a> </li>
                                <li class="list-inline-item"> <a target="_blank" class="btn btn-xs btn-icon btn-light-soft" href="<?= $site_row["linkedin"]; ?>"><i class="bi bi-linkedin lh-base"></i></a> </li>
                                <li class="list-inline-item"> <a target="_blank" class="btn btn-xs btn-icon btn-light-soft" href="<?= $site_row["youtube"]; ?>"><i class="bi bi-youtube lh-base"></i></a> </li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="d-md-flex justify-content-between align-items-center text-center text-lg-start py-4">
                <div class="text-body mb-3 mb-md-0" id="copyright"> Copyrights &copy; 2021 - <script>document.getElementById('copyright').appendChild(document.createTextNode(new Date().getFullYear()))</script> GMSA - CKTUTAS. </div>
            </div>
