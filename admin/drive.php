<?php 
    ...
    $count_drive = $statement->rowCount();
    ...
    if (isset($_GET['delete']) && !empty($_GET['delete'])) {
        ...
        if ($delete_image) {
            ...
            if ($result) {
                ...
                $log_message = "deleted drive file with id " . $id . "";
                                        ...
                                        <div class="list-group-item-body">
                                            <div class="media align-items-center">
                                                ...
                                                <div class="media-actions">
                                                    <a title="Download" href="<?= PROOT; ?>admin/auth/download?file=<?= 'assets/media/drive/' . $drive['drive_media']; ?>" class="btn btn-sm btn-secondary"><span class="oi oi-data-transfer-download"></span></a>&nbsp;
