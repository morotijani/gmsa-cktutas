                    ...
                    <div class="col-md-9 col-lg-6 text-center mx-auto">
                        <figure>
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 821.3 367.2" style="enable-background:new 0 0 821.3 367.2;" xml:space="preserve">
                                ...
                                <path class="fill-body" d="M381.2,67.3c0,1.5-0.6,2.9-1.8,3.9c-0.9,0.8-2.2,1.3-3.4,1.3c-0.2,0-0.5,0-0.7,0l-45.8-6.1v244.3h202.3V24.6 H381.2V67.3z"/>
                                <polygon class="fill-white" points="370.8,27.6 332.5,56 335.4,56.7 370.8,61.4           "/>
                                <polygon class="fill-primary opacity-4" points="370.8,27.6 332.5,56 335.4,56.7 370.8,61.4           "/>
