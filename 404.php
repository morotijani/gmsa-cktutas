...
<html lang="en">
    <head>
        ...
        <title>Gary Pie.</title>
        <meta name="description" content="Themebau">
        <meta name="author" content="RunWebRun">
        <link rel="icon" type="image/png" href="assets/media/logo/logo-nb-white.png">
        ...
        <!-- Themebau -->
        <link rel="stylesheet" href="assets/dist/css/themebau.min.css">
        <!-- Custom Styles -->
        <link rel="stylesheet" href="assets/css/garypie.css">
        <!-- END: Styles -->
        <!-- jQuery -->
    ...
    <body>
        ...
        <header class="navbar navbar-top navbar-expand navbar-fixed">
            <div class="container justify-content-between">
                <a class="navbar-brand" href="<?= PROOT; ?>index">
                    <img width="60" src="<?= PROOT; ?>assets/media/logo/logo-nb-black.png" alt="">
                </a>
                ...
                <ul class="nav navbar-nav">
                    <li class="nav-item navbar-dropdown navbar-dropdown-mega active">
                        <a href="<?= PROOT; ?>index" class="nav-link">
                    ...
                    <li class="nav-item navbar-dropdown">
                        <a href="<?= PROOT; ?>store" class="nav-link">
        ...
        <div class="navbar navbar-mobile navbar-mobile-style-2 navbar-dark" id="navbar-mobile-style-2">
            ...
            <div class="navbar-head">
                <div class="container justify-content-between">
                    <a class="navbar-brand" href="<?= PROOT; ?>index">
                        <img width="60" src="<?= PROOT; ?>assets/media/logo/logo-nb-white.png" alt="">
                    </a>
                        ...
                        <div class="navbar-body">
                            <ul class="nav navbar-nav navbar-nav-collapse">
                                ...
                                <li class="nav-item navbar-collapse">
                                    <a href="<?= PROOT; ?>store" class="nav-link" role="button">
                                        <span class="nav-link-name">shop</span>
                                        <svg class="collapse-icon" width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1 11L6 6L1 1" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                ...
                                <li class="nav-item navbar-collapse">
                                    <a href="<?= PROOT; ?>about-us" class="nav-link">
                                        <span class="nav-link-name">us.</span>
                                        <svg class="collapse-icon" width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M1 11L6 6L1 1" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                    </a>
                                ...
                                <li class="nav-item">
                                    <a href="<?= PROOT; ?>contact-us" class="nav-link">
                        ...
                        <div class="navbar-footer">
                            <div class="mb-60 text-white">
                                ...
                                <ul class="list-group borderless font-size-17">
                                    <li class="list-group-item">Email: <a href="mailto:info.garypie@gmail.com?subject=Test%20Address%20Email" class="text-decoration-none text-white">info.garypie@gmail.com</a></li>
                                    <li class="list-group-item">Phone: <a href="callto:+1 202-358-0309" class="text-decoration-none text-white">+233 243 874 525</a></li>
                                </ul>
                            </div>
                            <div class="mb-60 text-white">
                                <p class="lead mb-17 fw-medium">Address:</p>
                                <ul class="list-group borderless font-size-17">
                                    <li class="list-group-item">2260 Airport Round About,</li>
                                    <li class="list-group-item">Ghana, Kumasi 00233</li>
                                </ul>
                            </div>
 ...
 <div class="content-wrap">
            <div class="py-160 text-center">
                <div class="container shape-parent">
                    ...
                    <p class="h3 mb-10 show-on-scroll" data-show-duration="500" data-show-distance="10" data-show-delay="100">Page not found 😿</p>
                    <p class="mb-40 pb-2 show-on-scroll" data-show-duration="500" data-show-distance="10" data-show-delay="200">Perhaps you would like to go to our home page?</p>
                    <a href="<?= PROOT; ?>store" class="btn btn-dark btn-with-ball mb-15 show-on-scroll" data-show-duration="400" data-show-distance="10" data-show-delay="230">go to home</a>
                </div>
            </div>
        </div>
        <footer class="footer bg-dark text-white shape-parent overflow-hidden text-center pt-160 pb-60">
            ...
            <div class="container pt-4">
                <ul class="nav align-items-center flex-column text-white mb-100">
                    ...
                    <li class="nav-item">
                        <a href="callto:+1 202-358-0309" class="nav-link h4 mt-8 mt-md-0">+1 202-358-0309</a>
                    </li>
                </ul>
                ...
                <div class="footer-copyright mb-5">© 2020-2022 | Themebau by RunWebRun.</div>
            </div>
        </footer>
                ...
                <!-- Object Fit Polyfill -->
        <script src="assets/dist/js/ofi.min.js"></script>
        <!-- Bootstrap -->
        ...
        <!-- Animejs -->
        <script src="assets/dist/js/anime.min.js"></script>
        <!-- Rellax -->
        <script src="assets/dist/js/rellax.min.js"></script>
        <!-- Countdown -->
        <script src="assets/dist/js/jquery.countdown.min.js"></script>
        <!-- Moment.js -->
        <script src="assets/dist/js/moment.min.js"></script>
        <script src="assets/dist/js/moment-timezone-with-data.min.js"></script>
        <!-- Isotope -->
        <script src="assets/dist/js/isotope.pkgd.min.js"></script>
        <script src="assets/dist/js/packery-mode.pkgd.min.js"></script>
        <!-- Jarallax -->
        <script src="assets/dist/js/jarallax.min.js"></script>
        <script src="assets/dist/js/jarallax-video.min.js"></script>
        <!-- Fancybox -->
        <script src="assets/dist/js/jquery.fancybox.min.js"></script>
        <!-- Themebau -->
        <script src="assets/dist/js/themebau.min.js"></script>
        <!-- END: Scripts -->
    </body>
</html>
